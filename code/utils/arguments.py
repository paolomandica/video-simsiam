...
def train_args():
    parser = argparse.ArgumentParser(description='VFS Training')
    ...
    # Augmentations
    parser.add_argument('--color-aug', default=False, action='store_true')
    ...
    if args.output_dir == 'auto':
        keys = {
            ...
            'frame_skip': 'f_skip', 'clips_step': 'step', 'clips_per_video': 'clips'
        }
